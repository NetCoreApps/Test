...
// @Route("/image-bytes")
export class ImageAsBytes implements IReturn<Blob>
{
    public format: string;
...
// @Route("/image-custom")
export class ImageAsCustomResult implements IReturn<Blob>
{
    public format: string;
...
export class ImageWriteToResponse implements IReturn<Blob>
{
    public format: string;
...
// @Route("/image-file")
export class ImageAsFile implements IReturn<Blob>
{
    public format: string;
...
export class HelloImage implements IReturn<Blob>
{
    public name: string;
    public format: string;
    public width?: number;
